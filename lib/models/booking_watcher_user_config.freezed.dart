...
part of 'booking_watcher_user_config.dart';
...
mixin _$BookingWatcherUserConfig {
  ...
  @JsonKey(ignore: true)
  $BookingWatcherUserConfigCopyWith<BookingWatcherUserConfig> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BookingWatcherUserConfigCopyWith<$Res> {
  factory $BookingWatcherUserConfigCopyWith(BookingWatcherUserConfig value,
          $Res Function(BookingWatcherUserConfig) then) =
      _$BookingWatcherUserConfigCopyWithImpl<$Res>;
  $Res call(
      {String recipientEmail,
      DateTime startPreferredDate,
      DateTime endPreferredDate,
      TimeOfDay startPreferredTime,
      TimeOfDay endPreferredTime,
      List<String> preferredLocationIds});
}

/// @nodoc
class _$BookingWatcherUserConfigCopyWithImpl<$Res>
    implements $BookingWatcherUserConfigCopyWith<$Res> {
  _$BookingWatcherUserConfigCopyWithImpl(this._value, this._then);

  final BookingWatcherUserConfig _value;
  // ignore: unused_field
  final $Res Function(BookingWatcherUserConfig) _then;

  @override
  $Res call({
    Object? recipientEmail = freezed,
    Object? startPreferredDate = freezed,
    Object? endPreferredDate = freezed,
    Object? startPreferredTime = freezed,
    ...
    return _then(_value.copyWith(
      recipientEmail: recipientEmail == freezed
          ...
          : recipientEmail // ignore: cast_nullable_to_non_nullable
              as String,
      startPreferredDate: startPreferredDate == freezed
          ? _value.startPreferredDate
          : startPreferredDate // ignore: cast_nullable_to_non_nullable
              as DateTime,
      endPreferredDate: endPreferredDate == freezed
          ? _value.endPreferredDate
          : endPreferredDate // ignore: cast_nullable_to_non_nullable
              as DateTime,
      startPreferredTime: startPreferredTime == freezed
          ? _value.startPreferredTime
          : startPreferredTime // ignore: cast_nullable_to_non_nullable
              as TimeOfDay,
      endPreferredTime: endPreferredTime == freezed
          ? _value.endPreferredTime
...
class _$_BookingWatcherUserConfig extends _BookingWatcherUserConfig {
  const _$_BookingWatcherUserConfig(
      {required this.recipientEmail,
      required this.startPreferredDate,
  ...
  @override
  final DateTime startPreferredDate;
  @override
  final DateTime endPreferredDate;
  @override
  ...
  @override
  String toString() {
    return 'BookingWatcherUserConfig(recipientEmail: $recipientEmail, startPreferredDate: $startPreferredDate, endPreferredDate: $endPreferredDate, startPreferredTime: $startPreferredTime, endPreferredTime: $endPreferredTime, preferredLocationIds: $preferredLocationIds)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.startPreferredDate, startPreferredDate) &&
            const DeepCollectionEquality()
                .equals(other.endPreferredDate, endPreferredDate) &&
            const DeepCollectionEquality()
                .equals(other.startPreferredTime, startPreferredTime) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(recipientEmail),
      const DeepCollectionEquality().hash(startPreferredDate),
